.data
values: .byte 0x3F, 0x06, 0x5B, 0x4F, 0x66, 0x6D, 0x7D, 0x07, 0x7F, 0x6F, 0x77, 0xFF, 0x39, 0xBF, 0x79, 0x71 #representacoes hexadecimais dos numeros de 0 a F de acordo com o exercicio 1b
